        ...
        if self.slot_data_cache is None:
            self.slot_data_cache = {
                "options": {
                    ...
                    "wild_randomization_blacklist": self.options.wild_randomization_blacklist.value,
                    ...
                    "randomize_egg_species": self.options.randomize_egg_species.value,
                    ...
                    "replace_evo_methods": self.options.replace_evo_methods.value,
