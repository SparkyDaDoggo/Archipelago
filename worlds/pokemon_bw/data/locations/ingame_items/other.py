...
table: dict[str, FlagLocationData] = {
    ...
    "P2 Laboratory - Item from scientist #1": FlagLocationData(0x1E0, wild_rando_dependant, "P2 Laboratory", None, IF(randomized_wild, has_genesect)),
    "P2 Laboratory - Item from scientist #2": FlagLocationData(0x1E0, wild_rando_dependant, "P2 Laboratory", None, IF(randomized_wild, has_genesect)),
    "Accumula Town - Item from man in north west building": FlagLocationData(109, always_default, "Accumula Town North Left House 2F", None, None),
    "Striaton City - Item from man in south east building": FlagLocationData(111, always_default, "Striaton City East Lower House 1F", None, None),
    "Striaton City - Item from roughneck": FlagLocationData(189, always_default, "Striaton City", None, None),
    "Striaton City - Item from Cheren #1": FlagLocationData(192, always_default, "Striaton City Trainers' School", None, None),
    "Striaton City - Item from Cheren #2": FlagLocationData(192, always_default, "Striaton City Trainers' School", None, None),
    "Striaton City - Item from Cheren #3": FlagLocationData(192, always_default, "Striaton City Trainers' School", None, None),
    "Striaton City - Item from boy in Trainer's School": FlagLocationData(190, always_default, "Striaton City Trainers' School", None, None),
    "Striaton City - Item from Amanita": FlagLocationData(0x18C, always_default, "Striaton City East Upper House 2F", None, has_fought_plasma_dreamyard),
    "Striaton City - Item from fisherman": FlagLocationData(187, always_default, "Striaton City", None, can_use_surf),
    "Striaton Gym - Gym guide item": FlagLocationData(118, always_default, "Striaton Gym", None, None),
    "Route 3 - Item from pokémon breeder Adelaide": FlagLocationData(1420+20, always_default, "Route 3 North", None, None),
    "Route 3 - Item from girl after Wellspring Cave #1": FlagLocationData(0x18E, always_default, "Route 3 North", None, IF(shuffled_doors, has_fought_plasma_wellspring)),
    "Route 3 - Item from girl after Wellspring Cave #2": FlagLocationData(0x18E, always_default, "Route 3 North", None, IF(shuffled_doors, has_fought_plasma_wellspring)),
    "Route 3 - Item from girl after Wellspring Cave #3": FlagLocationData(0x18E, always_default, "Route 3 North", None, IF(shuffled_doors, has_fought_plasma_wellspring)),
    "Route 3 - Item from pokémon breeder Galen": FlagLocationData(1420+19, always_default, "Route 3 South", None, can_use_surf),
    ...
    "Nacrene City - Item from girl in west building": FlagLocationData(301, always_default, "Nacrene City South West Left House", None, None),
    ...
    "Battle Company - 47F item from clerk #1": FlagLocationData(266, always_default, "Battle Company 47F", None, None),
    "Battle Company - 47F item from clerk #2": FlagLocationData(266, always_default, "Battle Company 47F", None, None),
    "Battle Company - 47F item from clerk #3": FlagLocationData(266, always_default, "Battle Company 47F", None, None),
    "Battle Company - 47F item from clerk #4": FlagLocationData(266, always_default, "Battle Company 47F", None, None),
    "Battle Company - 47F item from clerk #5": FlagLocationData(266, always_default, "Battle Company 47F", None, None),
    "Battle Company - 47F item from clerk #6": FlagLocationData(266, always_default, "Battle Company 47F", None, None),
    ...
    "Route 4 - Item from Professor Juniper #4": FlagLocationData(0x19B, always_default, "Nimbasa South Gate", None, None),
    "Route 4 - Item from Professor Juniper #5": FlagLocationData(0x19B, always_default, "Nimbasa South Gate", None, None),
    "Route 4 - Item from Professor Juniper #6": FlagLocationData(0x19B, always_default, "Nimbasa South Gate", None, None),
    "Route 4 - Item from Professor Juniper #7": FlagLocationData(0x19B, always_default, "Nimbasa South Gate", None, None),
    "Route 4 - Item from Professor Juniper #8": FlagLocationData(0x19B, always_default, "Nimbasa South Gate", None, None),
    "Route 4 - Item from Professor Juniper #9": FlagLocationData(0x19B, always_default, "Nimbasa South Gate", None, None),
    "Route 4 - Item from Professor Juniper #10": FlagLocationData(0x19B, always_default, "Nimbasa South Gate", None, None),
    ...
    "Nimbasa City - Item from ace trainer in another western building": FlagLocationData(273, always_default, "Nimbasa City North East House 2F", None, None),
    "Nimbasa City - Item from man in eastern gate": FlagLocationData(367, always_default, "Nimbasa East Gate", None, None),
    "Nimbasa Gym - Gym guide item": FlagLocationData(121, always_default, "Nimbasa Gym", None, None),
    # Following trainers are said to appear randomly each day in big stadium or small court
    "Nimbasa City - Item from waiter Clint": FlagLocationData(1420+363, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from waitress Bonita": FlagLocationData(1420+364, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from nurse Kirsten": FlagLocationData(1420+385, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from doctor Jules": FlagLocationData(1420+384, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from baker Lilly": FlagLocationData(1420+377, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from scientist Simon": FlagLocationData(1420+365, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from scientist Blythe": FlagLocationData(1420+366, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from ace trainer Lucille": FlagLocationData(1420+357, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from ace trainer Charlie": FlagLocationData(1420+358, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from veteran Arlen": FlagLocationData(1420+359, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from veteran Sayuri": FlagLocationData(1420+360, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from nursery aide Leah": FlagLocationData(1420+378, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from youngster Kevin": FlagLocationData(1420+147, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from lass Dana": FlagLocationData(1420+354, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from backpacker Alexander": FlagLocationData(1420+383, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from backpacker Patty": FlagLocationData(1420+382, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from socialite Emilia": FlagLocationData(1420+369, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    "Nimbasa City - Item from gentleman Renaud": FlagLocationData(1420+370, always_excluded, "Any Big Stadium or Small Court", disabled, None),
    ...
    "Route 6 - Item from child in western house": FlagLocationData(261, always_default, "Route 6 North House", None, None),
    "Chargestone Cave - Item from Professor Juniper": FlagLocationData(0x1A3, always_default, "Chargestone Cave 1F", None, None),
    "Chargestone Cave - Item from nugget brothers #1": FlagLocationData(169, always_default, "Chargestone Cave B1F", None, None),
    "Chargestone Cave - Item from nugget brothers #2": FlagLocationData(169, always_default, "Chargestone Cave B1F", None, None),
    "Mistralton City - Item from veteran in Cargo Service building": FlagLocationData(144, always_default, "Mistralton Cargo Service", None, None),
    ...
    "Route 8 - Item from ranger Annie": FlagLocationData(1420+188, always_default, "Route 8 North East", None, None),
    ...
    "Shopping Mall Nine - Item from worker": FlagLocationData(262, always_default, "Shopping Mall Nine", None, None),
    ...
    "Opelucid City - Item from linebacker in Drayden's house": FlagLocationData(324, always_default, "Opelucid City Drayden's House 2F", None, None),
    "Opelucid City - Item from female NPC in Drayden's house": FlagLocationData(325, always_default, "Opelucid City Drayden's House 2F", None, None),
    "Opelucid Gym - Gym guide item": FlagLocationData(125, always_default, "Opelucid Gym", None, None),
    # Don't know how to handle pokémon from other version, so not changing the script
    ...
    "Opelucid City - Item from Professor Juniper": FlagLocationData(0x1B1, always_default, "Opelucid City", None, has_defeated_opelucid_gym),
    "Route 10 - Item from veteran near northern bridge": FlagLocationData(263, always_default, "Route 10", None, None),
    "Route 10 - Item from Bianca #1": FlagLocationData(0x1B2, always_default, "Route 10", None, has_heard_weather_route_10),
    "Route 10 - Item from Bianca #2": FlagLocationData(0x1B2, always_default, "Route 10", None, has_heard_weather_route_10),
    "N's Castle - Item from grunt in 3F left room": FlagLocationData(362, always_default, "N's Castle 3F Left Room", None, None),
}

seasonal: dict[str, FlagLocationData] = {
    "Route 6 - Item from scientist for all Deerling forms": FlagLocationData(350, deerling_dependant, "Season Research Lab", None, can_catch_all_deerlings),
}
