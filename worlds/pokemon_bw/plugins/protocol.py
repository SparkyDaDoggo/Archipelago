...
class PluginProtocol:
    """Initialized fields are filled to all imported Plugin classes (not overwritten!)"""
    ...
    _rom: NintendoDSRom  # Keeping for backwards compatibility
    _files_dump: dict[str, bytes | bytearray]
    _options: dict[str, Any]  # Keeping for backwards compatibility
    _settings: dict[str, Any]
    _arm9: bytearray  # Keeping for backwards compatibility
    _arm7: bytearray  # Keeping for backwards compatibility
