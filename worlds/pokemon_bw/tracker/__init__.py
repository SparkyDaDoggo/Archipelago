...
mapping_single: dict[int, int] = {
    ...
    277: 82,   # => "nscastle5f"
    274: 83,   # => "nscastlensroom"
    278: 84,   # => "nscastlethroneroom"
    155: 85,   # => "pinwheelforest"
    154: 86,   # => "pinwheelforestoutside"
    160: 87,   # => "reliccastle1f"
    161: 88,   # => "reliccastleb1f"
    162: 89,   # => "reliccastleb2f"
    163: 90,   # => "reliccastleb3f"
    164: 91,   # => "reliccastleb4f"
    165: 92,   # => "reliccastleb5f"
    166: 93,   # => "reliccastleb7f"
    190: 95,   # => "reliccastletower1f"
    189: 96,   # => "reliccastletowerb1f"
    188: 97,   # => "reliccastletowerb2f"
    187: 98,   # => "reliccastletowerb3f"
    186: 99,   # => "reliccastletowerb4f"
    185: 100,  # => "reliccastletowerb5f"
    184: 101,  # => "reliccastletowerb6f"
    183: 102,  # => "reliccastletowerb7f"
    182: 103,  # => "reliccastlevolcaronasroom"
    156: 104,  # => "ruminationfield"
    249: 105,  # => "skyarrowbridge"
    250: 105,  # => "skyarrowbridge"
    254: 106,  # => "tubelinebridge"
    199: 107,  # => "twistmountain"
    203: 108,  # => "twistmountainicerockcave"
    202: 109,  # => "twistmountainlowerlevel"
    201: 110,  # => "twistmountainmiddlelevel"
    198: 111,  # => "twistmountainoutside"
    200: 112,  # => "twistmountainupperlevel"
    240: 113,  # => "undellabay"
    222: 114,  # => "victoryroad1fleftmostroom"
    215: 115,  # => "victoryroad1fmiddleroom"
    220: 116,  # => "victoryroad1frightmostroom"
    216: 117,  # => "victoryroad2fleftroom"
    219: 118,  # => "victoryroad2frightroom"
    223: 119,  # => "victoryroad3fleftmostroom"
    217: 120,  # => "victoryroad3fmiddleroom"
    221: 121,  # => "victoryroad3frightmostroom"
    224: 122,  # => "victoryroad4fleftmostroom"
    218: 123,  # => "victoryroad4fmiddleroom"
    227: 124,  # => "victoryroad4frightmostroom"
    225: 125,  # => "victoryroad5f"
    226: 126,  # => "victoryroad6f"
    228: 127,  # => "victoryroad7f"
    214: 128,  # => "victoryroadoutside"
    229: 129,  # => "victoryroadtrialchamber"
    255: 130,  # => "villagebridge"
    324: 131,  # => "wellspringcave1f"
    325: 132,  # => "wellspringcaveb1f"
    423: 133,  # => "route17" these all are merged to one map
    387: 133,  # => "route18" these all are merged to one map
    238: 133,  # => "p2 lab" these all are merged to one map
}
